...
function ServiceBlock(props) {
    ...
    return (
        <div className={props.num == 1 ? "service ser_" + props.num + " on" : "service ser_" + props.num } data-service={props.num}>
            <div className="title">
                {props.title}
            </div>
...
const Services = () => {
    ...
    for (let i = 0; i < pack?.services.length; i++) {
        ...
        serviceBlocks.push(<ServiceBlock key={unique.key++} num={i+1} title={element.title} list={element.serviceList} />);
    }
